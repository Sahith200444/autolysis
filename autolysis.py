...
def extended_analysis(df):
    ...
    try:
        ...
        raise Exception(f"Error performing extended analysis: {e}")
...
def generate_plots(df, output_dir):
    ...
    try:
        ...
        raise Exception(f"Error generating plots: {e}")
...
def construct_dynamic_prompt(analysis):
    ...
    try:
        ...
        raise Exception(f"Error constructing dynamic prompt: {e}")
...
def create_readme(analysis, story, image_files, output_dir):
    ...
    try:
        ...
        raise Exception(f"Error creating README.md: {e}")
